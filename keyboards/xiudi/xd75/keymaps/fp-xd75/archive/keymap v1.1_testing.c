 ...
 */
 ...
 [BASE] = { /* BASE */
  ...
  { KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    	KC_TRNS,		KC_TRNS, 	KC_TRNS, 	KC_Y,    	KC_U,    KC_I,    KC_O,    KC_P,   	KC_PGDN  		},
...
[LNUM] = { /* LNUM */
  ...
  { KC_TRNS, KC_TRNS, 			KC_0,  KC_DOT, KC_EQL, KC_TRNS, 	KC_TRNS, KC_TRNS, KC_TRNS, MO(BOTH), KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, MO(LNUP) },
 }
};
